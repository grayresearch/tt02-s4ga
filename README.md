...
The project is currently configured to repeatedly evaluate N=79 K=5-LUTs with LL=14 cycles.
Each LUT configuration has this format:

    // LUT config:
    struct LUT_n79_k5 { // all fields big-endian, most signif. nybble first:
