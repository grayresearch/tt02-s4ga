...
The project is currently configured to repeatedly evaluate N=73 K=5-LUTs with LL=14 cycles.
Each LUT configuration has this format:

    // LUT config:
    struct LUT_n73_k5 { // all fields big-endian, most signif. nybble first:
